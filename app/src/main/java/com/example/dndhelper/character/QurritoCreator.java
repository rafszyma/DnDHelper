...
public class QurritoCreator {
    ...
    private static Spell[] GetLearnedSpells() {
        return new Spell[]{
                new Spell("Otumanienie", 0, SpellSchool.Enchantment, new HashSet<>(Arrays.asList(Class.Sorcerer, Class.Wizard)), new HashSet<>(Arrays.asList(SpellComponent.Verbal, SpellComponent.Somatic, SpellComponent.Material)), SpellRange.Close, "1 cel <4KW", "1 runda", SpellDefense.Will, "Humanoid o maksymalnie 4 KW traci następną akcję."),
                new Spell("Odporność", 0, SpellSchool.Abjuration, new HashSet<>(Arrays.asList(Class.Sorcerer, Class.Wizard)), new HashSet<>(Arrays.asList(SpellComponent.Verbal, SpellComponent.Somatic, SpellComponent.Material)), SpellRange.Touch, "Dotyk", "1 min", SpellDefense.Will, "Podmiot otrzymuje +1 do rzutów obronnych"),
                new Spell("Odczytanie Magii", 0, SpellSchool.Divination, new HashSet<>(Arrays.asList(Class.Sorcerer, Class.Wizard)), new HashSet<>(Arrays.asList(SpellComponent.Verbal, SpellComponent.Somatic, SpellComponent.Focus)), SpellRange.Self, "Ja", "10min / lvl", SpellDefense.None, "Pozwala odczytywać zwoje i księgi zaklęć"),
                new Spell("Wykrycie Magii", 0, SpellSchool.Divination, new HashSet<>(Arrays.asList(Class.Sorcerer, Class.Wizard)), new HashSet<>(Arrays.asList(SpellComponent.Verbal, SpellComponent.Somatic)), SpellRange.m18, "Stożek Emanacja", "1 min / lvl, koncentracja", SpellDefense.None, "Wykrywa czary i magiczne przedmioty w zasięgu 18m"),
                new Spell("Wykrycie Trucizny", 0, SpellSchool.Divination, new HashSet<>(Arrays.asList(Class.Sorcerer, Class.Wizard)), new HashSet<>(Arrays.asList(SpellComponent.Verbal, SpellComponent.Somatic)), SpellRange.Close, "Kratka przylegająca", "Instant", SpellDefense.None, "Wykrywa truciznę w jednej istocie lub przedmiocie"),
                new Spell("Dłoń Maga", 0, SpellSchool.Transmutation, new HashSet<>(Arrays.asList(Class.Sorcerer, Class.Wizard)), new HashSet<>(Arrays.asList(SpellComponent.Verbal, SpellComponent.Somatic)), SpellRange.Close, "Niemagiczny, nietrzymany przedmiot", "Koncentracja", SpellDefense.None, "Telekineza na 2,5 kg"),
                new Spell("Naprawa", 0, SpellSchool.Transmutation, new HashSet<>(Arrays.asList(Class.Sorcerer, Class.Wizard)), new HashSet<>(Arrays.asList(SpellComponent.Verbal, SpellComponent.Somatic)), SpellRange.m3, "Przedmiot o wadze < 0.5kg", "Instant", SpellDefense.Will, "Dokonuje drobnych napraw przedmiotu"),
                new Spell("Otwarcie / Zamknięcie", 0, SpellSchool.Transmutation, new HashSet<>(Arrays.asList(Class.Sorcerer, Class.Wizard)), new HashSet<>(Arrays.asList(SpellComponent.Verbal, SpellComponent.Somatic, SpellComponent.Focus)), SpellRange.Close, "Przedmiot lub wejście o wadze <15kg", "Instant", SpellDefense.Will, "Otwiera lub zamyka małe i lekkie przedmioty"),
                new Spell("Wiadomość", 0, SpellSchool.Transmutation, new HashSet<>(Arrays.asList(Class.Sorcerer, Class.Wizard)), new HashSet<>(Arrays.asList(SpellComponent.Verbal, SpellComponent.Somatic, SpellComponent.Focus)), SpellRange.Medium, "1 cel / lvl", "10 min / lvl", SpellDefense.None, "Rozmowa szeptem na odległość"),
                new Spell("Kuglarstwo", 0, SpellSchool.Universal, new HashSet<>(Arrays.asList(Class.Sorcerer, Class.Wizard)), new HashSet<>(Arrays.asList(SpellComponent.Verbal, SpellComponent.Somatic)), SpellRange.m3, "Opis", "1h", SpellDefense.None, "Powołuje do istnienia drobne sztuczki"),
                new Spell("Mistyczny Znak", 0, SpellSchool.Universal, new HashSet<>(Arrays.asList(Class.Sorcerer, Class.Wizard)), new HashSet<>(Arrays.asList(SpellComponent.Verbal, SpellComponent.Somatic)), SpellRange.Touch, "0.1m2", "Pernamentny", SpellDefense.None, "Umożliwia zapisanie prywatnej runy"),
                new Spell("Promień Mrozu", 0, SpellSchool.Evocation, new HashSet<>(Arrays.asList(Class.Sorcerer, Class.Wizard)), new HashSet<>(Arrays.asList(SpellComponent.Verbal, SpellComponent.Somatic)), SpellRange.Close, "1 cel", "Instant", SpellDefense.TouchAttackRanged, "Promień zadający 1k3 obrażeń od zimna"),
                new Spell("Raca", 0, SpellSchool.Evocation, new HashSet<>(Arrays.asList(Class.Sorcerer, Class.Wizard)), new HashSet<>(Arrays.asList(SpellComponent.Verbal)), SpellRange.Close, "Rozprysk", "Instant", SpellDefense.Endurance, "Istota pada ofiarą olśnienia (-1 do testów ataków)"),
                new Spell("Światło", 0, SpellSchool.Evocation, new HashSet<>(Arrays.asList(Class.Sorcerer, Class.Wizard)), new HashSet<>(Arrays.asList(SpellComponent.Verbal, SpellComponent.Material)), SpellRange.Touch, "Dotyk", "10 min / lvl", SpellDefense.None, "Przedmiot rozświetla się niczym pochodnia"),
                new Spell("Tańczące Światło", 0, SpellSchool.Evocation, new HashSet<>(Arrays.asList(Class.Sorcerer, Class.Wizard)), new HashSet<>(Arrays.asList(SpellComponent.Verbal, SpellComponent.Somatic)), SpellRange.Medium, "Do 4 świateł", "1 min", SpellDefense.None, "Tworzy pochodnie i innego typu światła"),
                new Spell("Widmowy odgłos", 0, SpellSchool.Evocation, new HashSet<>(Arrays.asList(Class.Sorcerer, Class.Wizard)), new HashSet<>(Arrays.asList(SpellComponent.Verbal, SpellComponent.Somatic, SpellComponent.Material)), SpellRange.Close, "Dźwięki", "1 runda / lvl", SpellDefense.Will, "Tworzy złudne dźwięki"),
