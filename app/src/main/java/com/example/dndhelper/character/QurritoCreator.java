...
public class QurritoCreator {
    ...
    private static Spell[] GetLearnedSpells() {
        return new Spell[] {
                ...
                new Spell("Wykrycie myśli", 2, SpellSchool.Divination, new HashSet<>(Arrays.asList(SpellComponent.Verbal, SpellComponent.Somatic, SpellComponent.Focus)), SpellRange.m18, "Emanacja w kształcie stożka", "Koncentracja, 1min / lvl", SpellDefense.Will, "Pozwala \"wsłuchiwać się\" w powierzchowne myśli"),
                new Spell("Podmuch wiatru", 2, SpellSchool.Evocation, new HashSet<>(Arrays.asList(SpellComponent.Verbal, SpellComponent.Somatic)), SpellRange.m18, "Linia ode mnie do granicy zasięgu", "1 runda", SpellDefense.Endurance, "Odpycha lub przewraca małe istoty."),
        };
    }
}
